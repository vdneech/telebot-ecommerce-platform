    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('telegram_chat_id', models.BigIntegerField(blank=True, null=True, verbose_name='Chat ID для рассылок')),
                ...
                ('registration_step', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='bot.registrationstep')),
